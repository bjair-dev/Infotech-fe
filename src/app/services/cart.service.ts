  ...
  AddProductToCart(id: Number, quantity?: number) {
    ...
    this.productService.getSingleProduct(id).subscribe(prod => {
      ...
      if (this.cartDataServer.data[0].product === undefined) {
        ...
        localStorage.setItem('cart', JSON.stringify(this.cartDataClient));
        this.cartDataObs$.next({...this.cartDataServer});
        this.toast.success(`${prod.nombre} Agregado al Carrito.`, "Producto Añadido", {
          timeOut: 1500,
          progressBar: true,
      ...
      // Cart is not empty
        ...
        if (index !== -1) {
          ...
          this.toast.info(`${prod.nombre} Cantidad Aumentada al Carrito.`, "Producto Añadido", {
            timeOut: 1500,
            progressBar: true,
            progressAnimation: 'increasing',
            positionClass: 'toast-top-right'
    ...
    this.httpClient.post(`${this.ServerURL}orders/payment`, null).subscribe((res: { success: Boolean }) => {
      ...
      if (res.success) {
        ...
        this.httpClient.post(`${this.ServerURL}orders/new`, {
          ...
          this.orderService.getSingleOrder(data.id_order).then(prods => {
            if (data.success) {
        ...
        this.toast.error(`Lo Siento, Fallo en la Orden del Producto`, "Estado de Orden", {
          timeOut: 1500,
          progressBar: true,
          progressAnimation: 'increasing',
          positionClass: 'toast-top-right'
